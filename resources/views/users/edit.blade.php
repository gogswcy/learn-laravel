...
<div class="container">
    <div class="col-md-8 offset-md-2">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data" method="POST" accepte-charset="UTF-8">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="name-filed" value="{{ old('name', $user->name) }}">
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="file" name="avatar" class="form-control-file" id="">
