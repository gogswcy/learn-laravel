      ...
      <div class="card-body">
        ...
        @endif
          ...
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="form-group">
                    <label for="replay_count-field">Replay_count</label>
                    <input class="form-control" type="text" name="replay_count" id="replay_count-field" value="{{ old('replay_count', $topic->replay_count ) }}" />
                </div> 
                <div class="form-group">
